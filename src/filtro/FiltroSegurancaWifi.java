...
public class FiltroSegurancaWifi implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
       ...
       if (  (ses != null && ses.getAttribute("usuarioWifi") != null && ses.getAttribute("senhaWifi") != null)
                                  || reqURI.indexOf("/site/wifi/body/") >= 0 && reqURI.contains("javax.faces.resource") )
              chain.doFilter(request, response);
       else   
       	//Usuario não tem sessao aberta ainda, portanto o servidor redireciona ele para a pagina de login.
              res.sendRedirect(req.getContextPath() + "/site/wifi/login.xhtml");  
 }
catch(Throwable t) {
